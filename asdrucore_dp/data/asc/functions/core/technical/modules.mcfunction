...
execute if score d.1 asc.d matches 1 run tellraw @a[tag=asc.core.dev] {"translate":"module.smd.core","with":[{"text":"\ua000","font":"asc:core"}]}
execute if score d.1 asc.d matches -1 run tellraw @a[tag=asc.core.dev] {"translate":"module.smd.core_not_loaded","color":"dark_red","clickEvent":{"action":"open_url","value":"https://github.com/TheNuclearNexus/SmithedCore"}}
...
execute if score d.0 asc.d matches 1 run scoreboard players set d.1 asc.d 1
execute unless score d.0 asc.d matches 1 run scoreboard players set d.1 asc.d -1
execute if score d.0 smd.inv_change matches 1 run tellraw @a[tag=asc.core.dev] {"translate":"module.smd.crafter","with":[{"text":"\ua001","font":"asc:core"}]}
execute if score d.1 asc.d matches -1 run tellraw @a[tag=asc.core.dev] {"translate":"module.smd.crafter_not_loaded","color":"dark_red","clickEvent":{"action":"open_url","value":"https://github.com/TheNuclearNexus/SmithedCrafter"}}
